...
public:
	...
	cl::Event runSDF(CLManager* cl, int SDFmethod, cl::Image2D& img_mask, cl::Image2D& img_sdf, 
			int max_warp_size, int width, int height, cl::Event evWrtImg, char* save_path);

	cl::Event runSDFBuf(CLManager* cl, int SDFmethod, cl::Buffer& buf_mask, cl::Buffer& buf_sdf, 
			int max_warp_size, int width, int height, cl::Event evWrtImg,char* save_path);
...
private:
    ...
    cl::Event voroHalfSDF(int posValues);//Using images
    cl::Event voroHalfSDFBuf(int posValues);//Using buffers
    cl::Event voroHalfSDF_3DBuf(int posValues);//Using buffers
    ...
    cl::Image2D img_mask;
    cl::Image2D img_sdf;
    cl::Image2D img_sdf_half;
    cl::Image2D img_sdf_half2;
